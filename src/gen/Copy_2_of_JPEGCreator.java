...
public class Copy_2_of_JPEGCreator{
	...
	static int[][] im = new int[1000][1000];
	static void  in(){
    ...
    public static void main( String args[] ) throws Exception {
       ...
       Copy_2_of_JPEGCreator.generate( Integer.toString(k));
       Random n = new Random();
       im[0][0]=im[0][0]+16777215;
       /*
       System.out.print(" "+R);
       System.out.print(" "+G);
       System.out.print(" "+B);
       ...
       for(int i =0;i<1000;i++){
    	   for(int j =0;j<1000;j++){
        	   if(im[i][j]>16777215){
        		   ...
        		   if(j<999){im[i][j+1]=im[i][j+1]+16777215;}
        		   if(j==999){im[i+1][0]=im[i+1][0]+16777215;}
        		break;
        	   }
           }
       }/*for(int i =0;i<100;i++){
